...
(function() {
    ...
    setTimeout(()=>{
    document.getElementById("min").innerHTML = 12},1000)
...
function twelfthQuestion() {
    ...
    var storageRef = firebase.storage().ref().child('FireImages/twelfth.JPG');
    storageRef.getDownloadURL().then(function(url) {

        var test = url;
        var image1 = document.createElement('img');
        image1.setAttribute('src', test);
        image1.setAttribute('alt', 'Image');
        div.appendChild(image1);
...
function fourteenthQuestion() {
    ...
    var storageRef = firebase.storage().ref().child('FireImages/fourteenth.JPG');
    storageRef.getDownloadURL().then(function(url) {
...
function fifteenthQuestion() {
    ...
    var storageRef = firebase.storage().ref().child('FireImages/fifteenth.JPG');
    storageRef.getDownloadURL().then(function(url) {
...
function seventeenthQuestion() {
    ...
    var storageRef = firebase.storage().ref().child('FireImages/seventeenth.JPG');
    storageRef.getDownloadURL().then(function(url) {
...
function eighteenthQuestion() {
    ...
    var storageRef = firebase.storage().ref().child('FireImages/eighteenth.JPG');
    storageRef.getDownloadURL().then(function(url) {
...
function twentiethQuestion() {
    ...
    var storageRef = firebase.storage().ref().child('FireImages/twentieth.JPG');
    storageRef.getDownloadURL().then(function(url) {
